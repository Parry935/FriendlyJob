...
export default function ProgrammerOffersFilter() {
  const { programmerQuery, setProgrammerQuery } = useContext(ProgrammerContext);

  const [filterSwitch, setFilterSwitch] = useState({
    checkedW1: programmerQuery.educationV,
    checkedW2: programmerQuery.educationE,
    checkedW3: programmerQuery.educationM,
    checkedW4: programmerQuery.educationNS,
    checkedJobTimeFull: programmerQuery.jobTimeFull,
    checkedJobTime34: programmerQuery.jobTime34,
    checkedJobTime12: programmerQuery.jobTime12,
    checkedJobTimeNotSpecified: programmerQuery.jobTimeNS,
    checkedContractP: programmerQuery.contractP,
    checkedContractB: programmerQuery.contractB,
    checkedContractZ: programmerQuery.contractM,
    checkedContractNotSpecified: programmerQuery.contractNS,
    checkedRemote: programmerQuery.remote,
  });
  ...
  const [experienceFrom, setExperienceFrom] = useState(programmerQuery.expFrom);
  const [experienceTo, setExperienceTo] = useState(programmerQuery.expTo);
  const [language, setLanguage] = useState(programmerQuery.language);

  const [localizationRef, setLocalizationRef] = useState("");
  const [localization, setLocalization] = useState(
    programmerQuery.localization
  );
  ...
  const [phrase, setPhrase] = useState(programmerQuery.phrase);
  ...
  const [technologyMain, setTechnologyMain] = useState(
    programmerQuery.technologyMain
  );
  ...
  const [technologyNiceToHave, setTechnologyNiceToHave] = useState(
    programmerQuery.technologyNiceToHave
  );
      ...
      <View style={styles.card}>
        ...
        <View style={styles.rowWrap}>
          <View style={styles.itemCenter}>
            <Text>Zawodowe</Text>
            <Switch
              onValueChange={(event) => handleChangeSwitch(event, "checkedW1")}
              value={filterSwitch.checkedW1}
            />
          </View>
          <View style={styles.itemCenter}>
            <Text>Licencjat/inżynier</Text>
            <Switch
              onValueChange={(event) => handleChangeSwitch(event, "checkedW2")}
              value={filterSwitch.checkedW2}
            />
          </View>
          <View style={styles.itemCenter}>
            <Text>Magister</Text>
            <View>
              <Switch
                onValueChange={(event) =>
                  handleChangeSwitch(event, "checkedW3")
                }
                value={filterSwitch.checkedW3}
              />
            </View>
          </View>
          <View style={styles.itemCenter}>
            ...
            <Switch
              onValueChange={(event) => handleChangeSwitch(event, "checkedW4")}
              value={filterSwitch.checkedW4}
            />
          </View>
        </View>
      </View>
